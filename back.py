...
os.environ['OPENAI_API_KEY'] = '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'
...
def process_doc(
    ...
    # OpenAIEmbeddings = realizar respuestas a preguntas en base en la recuperación
